"""brains_21898 URL Configuration
...
admin.site.site_header = "Brains"
admin.site.site_title = "Brains Admin Portal"
admin.site.index_title = "Brains Admin"

# swagger
api_info = openapi.Info(
    title="Brains API",
    default_version="v1",
    description="API documentation for Brains App",
)
